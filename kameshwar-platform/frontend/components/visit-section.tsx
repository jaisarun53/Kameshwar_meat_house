    ...
    <section id="visit" className="section-shell py-24">
      <div className="grid gap-6 lg:grid-cols-[0.95fr_1.05fr]">
        ...
        <div id="contact" className="glass-panel rounded-[2rem] p-7 sm:p-8">
          ...
          <h3 className="mt-4 font-display text-4xl text-ash">What still needs owner input</h3>
          <ul className="mt-8 space-y-4 text-base leading-7 text-[#ddc4a5]">
            <li>Final menu with prices</li>
            <li>Real gallery photos and cooking visuals</li>
            <li>Exact opening hours</li>
            <li>Verified blog and YouTube feature links</li>
            <li>Brand logo and preferred spelling in English and Nepali</li>
          </ul>
        </div>
      </div>
    </section>
