      ...
      <div className="site-shell py-20 lg:py-28">
        <Reveal>
          <div className="section-heading-wrap">
            <p className="section-label text-[#a3472f]">The Menu</p>
            <h2 className="section-title text-[#2d2824]">Signature dishes with a calmer, more uniform presentation.</h2>
              ...
              <article className="menu-card menu-card-refined">
                ...
                <div className="menu-card-copy">
                  <div className="flex flex-col gap-4">
                    ...
                    <p className="text-sm leading-7 text-[#5c5147]">{item.description}</p>
                  </div>
                </div>
              </article>
            </Reveal>
