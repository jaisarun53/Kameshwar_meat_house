    ...
    <section id="menu" className="section-shell py-24">
      <div className="mb-10 flex flex-col gap-4 lg:flex-row lg:items-end lg:justify-between">
        ...
        <p className="max-w-2xl text-base leading-7 text-[#d9c0a0]">
          These dishes now reflect your family\'s actual starter menu. Prices are intentionally
          left open until the family confirms the final NPR rates for launch.
        </p>
      </div>
            ...
            <div className="mt-6 space-y-5">
              {category.menuItems.map((item) => (
                ...
                >
                  ...
                  <p className="text-sm font-semibold uppercase tracking-[0.2em] text-turmeric sm:pt-2">
