      ...
      <div className="site-shell py-20 lg:py-28">
        <Reveal>
          <div className="section-heading-wrap">
            <p className="section-label text-[#a3472f]">Our Story</p>
          ...
          <div className="space-y-5">
            <Reveal>
              <div className="story-summary-card">
                <p className="section-label text-[#a3472f]">Legacy</p>
                <h3 className="mt-4 font-display text-5xl leading-[0.95] text-[#2d2824]">
                  {businessInfo.storyTitle}
                </h3>
                <p className="mt-5 text-base leading-8 text-[#594f46]">{businessInfo.story}</p>
              </div>
            </Reveal>
            ...
            <Reveal delay={0.28}>
              <div className="legal-note-card">
                <p className="section-label text-[#a3472f]">Business Name</p>
                <p className="mt-4 font-display text-3xl leading-tight text-[#2d2824]">
